...
import { CircleDollarSign, Fingerprint, Images, Inbox, LayoutDashboard, LifeBuoy, LineChart, ScrollText, Shield, Users, type LucideIcon } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/support", label: "Support", icon: LifeBuoy, requiresRole: ["SUPPORT", "SUPERADMIN"] },
  ...
  { href: "/admin/spec-test", label: "Spec Test leads", icon: Fingerprint, requiresRole: ["SUPERADMIN"] },
