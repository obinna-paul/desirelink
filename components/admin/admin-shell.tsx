...
import { CircleDollarSign, Compass, Images, Inbox, LayoutDashboard, LifeBuoy, LineChart, ScrollText, Shield, Users, type LucideIcon } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/spec-test", label: "Spec Test leads", icon: Compass, requiresRole: ["SUPERADMIN"] },
