...
import { CircleDollarSign, Images, Inbox, LayoutDashboard, LifeBuoy, LineChart, ScrollText, Shield, Sparkles, Users, type LucideIcon } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/admin/spec-test", label: "Spec Test leads", icon: Sparkles, requiresRole: ["SUPERADMIN"] },
