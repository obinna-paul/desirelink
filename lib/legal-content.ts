  ...
  sections: [
    {
      ...
      bullets: [
        "Account & profile information: email, username, display name, bio, gender, orientation, photos, city and location, and account type (Explorer, Creator, Host, Service Provider, or Pair).",
        "Content you create: posts, comments, messages, live streams, event listings, service listings, and reviews.",
        "Verification information: creators, hosts, and service providers submit a government ID photo and a short selfie video so we can confirm they're real adults. These are reviewed manually and deleted immediately afterward — we never use them for anything else.",
        "Payment information: subscriptions, hearts, event tickets, and service bookings are processed by Paystack. We don't store your full card details ourselves.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Creators, hosts, and service providers must complete identity verification before posting premium content, hosting events, or listing services.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "Some features — subscriptions, hearts and gifting, event tickets, service bookings — involve real payments processed through Paystack. Prices, subscription terms, and refund eligibility are shown at the time of purchase; hearts and gifts are generally non-refundable once sent.",
        "Providers are responsible for accurately describing their services or events and for fulfilling what they offer.",
      ],
    },
    {
      heading: "6. Live streaming & events",
      paragraphs: [
        "Live streams and events must follow the same conduct rules as the rest of the platform. Hosts are responsible for what happens during their stream or event, and we may end a stream or cancel an event that violates our policies.",
      ],
    },
    {
  ...
  sections: [
    {
      ...
      paragraphs: [
        "We verify that creators, hosts, and service providers are real adults using a government ID and a short selfie video. This helps prevent fake accounts, but it doesn't guarantee someone's intentions — always use your own judgment.",
      ],
    },
    {
