...
function JoinCta({ resultId }: { resultId: string }) {
  return (
    <RevealSection delayMs={640} className="flex flex-col items-center gap-4 rounded-2xl border border-border/60 bg-card p-6 text-center shadow-card">
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-10 px-4 py-12 sm:px-8">
        ...
        {/* 5. How you handle uncertainty - the taker's attachment-response read, in ordinary
        ...
        {/* 6. Your likely dating loop - only the modules that actually converged */}
        ...
        {/* 9. Who tends to work for you */}
        <RevealSection delayMs={500} className="flex flex-col gap-3 rounded-2xl border border-border/60 bg-card p-5 shadow-card">
        ...
        {/* 10. One experiment */}
        <RevealSection delayMs={560} className="flex flex-col gap-2">
        ...
        <RevealSection delayMs={580} className="flex flex-col gap-1 text-center">
